...
dataset_paths = {
    "train": "data/datasets/conll04/train.json",
    "dev": "data/datasets/conll04/dev.json",
    "test": "data/datasets/conll04/test.json",
}

# Define your output paths
output_paths = {
    "train": "extracted_triples_data/conll04/train_triples.json",
    "dev": "extracted_triples_data/conll04/dev_triples.json",
    "test": "extracted_triples_data/conll04/test_triples.json",
}
